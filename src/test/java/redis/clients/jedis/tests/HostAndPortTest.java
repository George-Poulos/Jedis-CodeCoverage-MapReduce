...
public class HostAndPortTest {
  ...
  public void setLocalhost(){
    ...
    int port = 6379;
    HostAndPort hp = HostAndPort.parseString(host + ":" + Integer.toString(port));
    hp.setLocalhost("localhost");
    assertEquals("localhost", HostAndPort.localhost);
  }
  ...
  public void getLocalhost(){
    ...
    HostAndPort hp = HostAndPort.parseString(host + ":" + Integer.toString(port));
    hp.setLocalhost("localhost");
    assertEquals("localhost", HostAndPort.getLocalhost());

    hp.setLocalhost(null);
    assertEquals(HostAndPort.getLocalHostQuietly(), hp.getLocalhost());
  }

  @Test
  public void getLocalhostQuietly(){
    String host = "2a11:1b1:0:111:e111:1f11:1111:1f1e:1999";
    int port = 7384;
    HostAndPort hp = HostAndPort.parseString(host + ":" + Integer.toString(port));
    hp.setLocalhost("localhost");
    assertEquals(HostAndPort.getLocalHostQuietly(), hp.getLocalHostQuietly());
  ...
  public void equals(){
    ...
    HostAndPort hp = HostAndPort.parseString(host + ":" + Integer.toString(port));
    HostAndPort tmp = hp;
    assertEquals(true, hp.equals(tmp));
  }
